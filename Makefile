...
# FFLAGS_NOOPT = -O0 -g -ftrapuv -check all -debug -traceback -gen-interfaces -warn interfaces -fp-model source
##FFLAGS = ${FFLAGS_NOOPT}
#
...
ifeq ($(PLATFORM),Linux)
#
FF77 = mpif90 -c -fixed -extend-source -r8 -mcmodel=large
FF90 = mpif90 -c -free -r8 -mcmodel=large
CC = mpicc -c -O3 -DLINUX -mcmodel=large
#
FFLAGS = -O2 -fp-model source -march=core-avx2
#debugging:
#FFLAGS = -O2 -fp-model source -march=core-avx2 -debug -traceback -check bounds
FFLAGS_O1 = -O1 -fp-model source -march=core-avx2
