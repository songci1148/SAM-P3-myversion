...
!bloss/SAM: Use the SAM esati from sat.f90
        polysvp1 = 100.*esati(t) ! convert from hPa to Pa

!       Flatau formulation:
!bloss/SAM         dt       = max(-80.,t-273.16)
!bloss/SAM         polysvp1 = a0i + dt*(a1i+dt*(a2i+dt*(a3i+dt*(a4i+dt*(a5i+dt*(a6i+dt*(a7i+       &
!bloss/SAM                    a8i*dt)))))))
!bloss/SAM         polysvp1 = polysvp1*100.
...
! LIQUID
!bloss/SAM: Use the SAM esatw from sat.f90
        polysvp1 = 100.*esatw(t) ! convert from hPa to Pa

!       Flatau formulation:
!bloss/SAM         dt       = max(-80.,t-273.16)
!bloss/SAM         polysvp1 = a0 + dt*(a1+dt*(a2+dt*(a3+dt*(a4+dt*(a5+dt*(a6+dt*(a7+a8*dt)))))))
!bloss/SAM         polysvp1 = polysvp1*100.
