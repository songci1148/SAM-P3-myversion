...
!bloss: Option to turn off cloud radiative effects
logical:: disablecloudradiation = .false.
logical:: disablecloudradiation_sw = .false.

logical:: acre3d= .false. !BG for 3D SW LW acre diagnostic output
logical:: trac3d= .false. !BG for 3D tracer concentrations diagn output
logical:: csky3d= .false. !Bg for 3D clear sky heating rates diagn output
logical:: write_w2_sgs=.false. !BG for 3D output of w2_sgs (subgrid scale w2 variance)
