...
real,public :: ramp_min = 0.1 !INP ramp parameter ramp_min*NumCirrusINP = at lower temperature level, e.g. 0.2*2.e-3 !BG
...
!BG added for micro sensitivities:
   ...
   logical, public :: dust_ramp =.false. !make a linear ramp for dust INP concentration, decreasing with temperature !BG
   
   logical, public :: do_wtke =.false.   !BG use w from subgrid scale tke, calculated as w = sqrt(0.667*tke_sgs)     !BG
